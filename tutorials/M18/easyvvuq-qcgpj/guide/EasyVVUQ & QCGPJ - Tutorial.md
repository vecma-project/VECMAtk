...
1.  Please check and update if needed the content of environment configuration
    file located in:
    `~/tutorial/VECMAtk/tutorials/M18/easyvvuq-qcgpj/app/easypj_conf.sh`. This
...
2.  Go into the
    `~/tutorial/VECMAtk/tutorials/M18/easyvvuq-qcgpj/local_execution`:
    ```
    (easyvvuq-qcgpj)$ cd ~/tutorial/VECMAtk/tutorials/M18/easyvvuq-qcgpj/local_execution
    ```
...
1.  Go into the `~/tutorial/VECMAtk/tutorials/M18/easyvvuq-qcgpj/slurm_execution`
    ```
...
2.  Go into the `~/tutorial/VECMAtk/tutorials/M18/easyvvuq-qcgpj/qcg_execution`
    ```
